...
const IconLoading = ({ color, ...props }:IconType ) => {
  return (  
  <svg {...props} version="1.1" id="loader-1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
